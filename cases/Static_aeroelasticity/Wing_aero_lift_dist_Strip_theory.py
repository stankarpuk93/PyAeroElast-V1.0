...
def PyAeroElast_input():
    ...
    """
        Description:
            Input-file for a Modified lift distribution analysis
    ...
    Wing.chords.aileron_ratios = [0, 0]
    ...
    General.aerodynamics.Mach        = 0.586
    ...
    # Aerodynamic Data
    Static.aerodynamics.load_factor = 4                                # load factor foe a steady pull-up maneuver
