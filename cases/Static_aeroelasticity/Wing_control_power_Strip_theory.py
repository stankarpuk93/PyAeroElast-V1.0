...
def PyAeroElast_input():
    ...
    """
        Description:
            Input-file for an elastic control analysis
    ...
    Wing.chords.Y              = [0, 320, 500]
    Wing.chords.chords         = [225, 132.516, 100]
    Wing.chords.aileron_ratios = [0, 0.3, 0.3]
    Wing.sweep.leading_edge    = [3.5, 3.5]
    Wing.sweep.elastic_axis    = [0, 0]
    Wing.incidence             = [0, 0, 0]
    Wing.weight                = 125000
    ...
    Aerodynamics.alpha = [-6, -4, -2, 0, 2, 4, 6, 8, 10, 12, 14]
    ...
    # Aerodynamic Data
    Static.aerodynamics.load_factor = 3                                # load factor foe a steady pull-up maneuver
