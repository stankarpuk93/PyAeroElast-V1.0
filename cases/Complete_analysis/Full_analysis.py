...
def PyAeroElast_input():
    ...
    Wing.chords.Y              = [0, 310, 500]                       
    Wing.chords.chords         = [225, 132.5, 100]
    Wing.chords.aileron_ratios = [0, 0.25, 0.25]
    Wing.sweep.leading_edge    = [3.5, 3.5]
    Wing.sweep.elastic_axis    = [0, 0]
    Wing.incidence             = [2, 0, -1]
    Wing.weight                = 83838
    ...
    General.aerodynamics.Mach        = 0.45 
    ...
    Aerodynamics.Cla   = 6.28
    Aerodynamics.a0    = [0, 0, 0]
    Aerodynamics.alpha = [-4, -2, 0, 2, 4, 6, 8]
    ...
    # Structural Data
    Static.structures.mg              = [17400, 6039, 10200, 4200, 3400, 680]
    Static.structures.distances.to_AC = [22.5, 20.25, 17.85, 15.8, 13.3, 11.05]         # positive if ahead of the EA
    Static.structures.distances.to_CG = [0, 7, 13.734, -2, -2, -4]                      # positive if ahead of the EA
    # Aerodynamic Data
    Static.aerodynamics.load_factor = 5                                
    Static.aerodynamics.wing.CmAC   = [-0.015, -0.015, -0.015, -0.015, -0.015, -0.015]
    ...
    Dynamic.structures.distances.to_CG = [0, 7, 13.734, -2, -2, -4]                         # positive if ahead of the EA
    Dynamic.structures.Iyy             = [8.723*10**6, 8.723*10**6, 93.16*10**6, 3.725*10**6, 2.775*10**6, 0.4*10**6]
    ...
    General.aerodynamics.airspeed         = General.aerodynamics.Mach * (1.4 * 1716 * \
                                                                         General.aerodynamics.temperature)**0.5
